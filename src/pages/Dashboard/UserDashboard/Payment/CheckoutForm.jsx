...
const CheckoutForm = ({ offered }) => {
  ...
  const totalPrice = offered?.offeredAmount;
    ...
    //   console.log("payment intent", paymentIntent);
      if (paymentIntent.status === "succeeded") {
        ...
        const payment = {
          ...
          propertyPrice: offered?.propertyPrice,
          propertyImage: offered?.propertyImage,
          ...
          axiosSecure.patch(`/makeOffers/${offered._id}`, payment);
        // console.log("payment saved", res.data);
        if (res.data?.paymentResult?.insertedId) {
          Swal.fire({
            position: "top-end",
            icon: "success",
            title: "Thank you for buying the property",
